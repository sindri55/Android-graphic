...
public class ConcertServiceStub implements ConcertService {
    ...
    public ArrayList<Concert> getConcertList() {
        ...
        list.add(new Concert("Gunni Jóhannsson", 0, "Gunni stígur villtan dans í Kaplakrikanum og verður mikið gaman mikið fjör", "May 21, 2015", "15:00", image));
        list.add(new Concert("Gústafur Finnson", 0, "Gústi kallinn stendur alltaf fyrir sínu...", "May 21, 2015", "15:00", image));
        list.add(new Concert("Brynjar Jónsson", 1, "Hann Brynjar spilar á harmonikku heima hjá sér undir teppi", "May 21, 2015", "15:00", image));
